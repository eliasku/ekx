...
private:
    ...
    aaudio_result_t loadSymbols() {
        ...
        if (libHandle == nullptr) {
            OBOE_LOGI("%s() could not find " LIB_AAUDIO_NAME, __func__);
        ...
        if (mAAudioStream_isMMap == nullptr) {
            OBOE_LOGI("%s() could not find " FUNCTION_IS_MMAP, __func__);
            return AAUDIO_ERROR_UNAVAILABLE;
        }
        ...
        if (mAAudio_setMMapPolicy == nullptr) {
            OBOE_LOGI("%s() could not find " FUNCTION_SET_MMAP_POLICY, __func__);
            return AAUDIO_ERROR_UNAVAILABLE;
        }
        ...
        if (mAAudio_getMMapPolicy == nullptr) {
            OBOE_LOGI("%s() could not find " FUNCTION_GET_MMAP_POLICY, __func__);
            return AAUDIO_ERROR_UNAVAILABLE;
        }
